...
test('getProducerRtpParametersMapping(), getConsumableRtpParameters(), getConsumerRtpParameters() and getPipeConsumerRtpParameters() succeed', () => {
    ...
    const consumerRtpParameters = ortc.getConsumerRtpParameters(consumableRtpParameters, remoteRtpCapabilities, false);
    ...
    const pipeConsumerRtpParameters = ortc.getPipeConsumerRtpParameters(consumableRtpParameters);
